package com.bawei.lvwenjing.daynews.newsdrag;
...
public class ChannelActivity extends Activity implements OnItemClickListener {
  ...
  //  ArrayList<ChannelItem> otherChannelList = new ArrayList<ChannelItem>();
   ...
   // ArrayList<ChannelItem> userChannelList = new ArrayList<ChannelItem>();
    ...
    List<HttpBean.DataBeanX.DataBean> userChannelList;
    List<HttpBean.DataBeanX.DataBean> otherChannelList;
...
//        getMenuInflater().inflate(R.menu.main, menu);
        ...
        switch (parent.getId()) {
            case R.id.userGridView:
                ...
                if (position != 0 && position != 1) {
                    ...
                    if (moveImageView != null) {
                        ...
                        final HttpBean.DataBeanX.DataBean channel = ((HttpDragAdapter) parent.getAdapter()).getItem(position);//获取点击的频道内容
            ...
            case R.id.otherGridView:
                ...
                if (moveImageView != null){
                    ...
                    final int[] startLocation = new int[2];
                    newTextView.getLocationInWindow(startLocation);
                    final HttpBean.DataBeanX.DataBean channel = ((HttpOtherAdapter) parent.getAdapter()).getItem(position);
     ...
     * @param clickGridView
     */
    private void MoveAnim(View moveView, int[] startLocation,int[] endLocation, final HttpBean.DataBeanX.DataBean moveChannel,
